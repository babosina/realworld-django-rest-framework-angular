# DISCLAIMER. THIS IS THE FORK MADE FOR LOCAL TESTING ONLY
# Added a dockerized solution
# Angular and Django code remains the same 
...
This codebase was created to demonstrate a fully fledged fullstack application built with **Django REST Framework +
Angular** including CRUD operations, authentication, routing, pagination, and more.
...
This command will install and start the Angular development server. You can access the Angular application through your
web browser at `http://localhost:4200`.
...
- Apply db seed:
```shell
cd backend && python3 manage.py seed_db
```
